...
function splitLogs() {
    ...
    const mainHandObject = Orion.ObjAtLayer('RightHand');
...
function findToolSerial(type) {
    ...
    if (type === 'mining') {
        ...
        return Orion.ObjAtLayer('RightHand').Serial();
    }
}
...
const ToolTypes = {
    ...
    lumberjacking: [0x0F48, 0x0F49, 0x0F47, 0x0F4B, 0x0F45, 0x13FB, 0x1443, 0x13B0] // Axes.
};
